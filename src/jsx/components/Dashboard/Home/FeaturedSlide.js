...
export const FeaturedSlide = () => {
   const { jobsList } = useSelector((state) => state.profile);
   ...
   return (
      <>
      {jobsList?.length > 0 && isLoading===false  ? (
         <Slider {...settings}>
            {jobsList.slice(0, 5).map((job, index) => (
            <div className="items me-2" key={index}>
               <div className="card">
                  ...
                  <div className="media">
                     ...
                     <div className="media-body">
                        <h6
                        className="fs-16 text-black font-w600"
                        style={{
         ...
         <div className="facade col-xl-12">
