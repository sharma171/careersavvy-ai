...
import "../../components/Dashboard/Interview/banner.css";
    ...
    <Fragment>
      ...
      onPaste={handlePaste}>
        <div className="examTopSection">
          ...
          Duration : {startData?.interview_info?.estimated_duration}
          </div>
        ...
        {showPopup && (
          ...
          <div className="full-screen-popup">
            ...
            <div className="row-flex" style={{justifyContent:"space-between"}}>
              ...
              <p>Thank you for taking the time to interview for the Software Engineer position at TechCorp. I've enjoyed our conversation and learning about your experience with React and system design. Your approach to solving complex problems really impressed me. This concludes our interview.</p>
            </div>
          </div>
          </div>
          </>
